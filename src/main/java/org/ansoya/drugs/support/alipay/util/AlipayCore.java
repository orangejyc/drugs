package org.ansoya.drugs.support.alipay.util;


import org.ansoya.drugs.support.alipay.config.AlipayConfig;
import org.ansoya.drugs.support.alipay.sign.MyBase64;
...
public class AlipayCore {
    ...
    public static String sign(String content, String privateKey) {
        try {
            PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(MyBase64
                    .decode(privateKey));
    ...
    public static String getOrderInfo(String subject, String body, String price) {
        ...
        orderInfo += "&notify_url=" + "\""
                + "http://139.196.30.42/drugs/index.jsp" + "\"";
